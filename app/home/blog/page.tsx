...
export default function BlogPage() {
    ...
    const otherBlogs = filteredBlogs.filter((b) => !b.isFeatured).slice(0, visibleCount)
    const hasMore = visibleCount < filteredBlogs.filter((b) => !b.isFeatured).length

    // Get featured blog color based on category, with fallback
    const featuredColor = featuredBlog ? getCategoryColor(featuredBlog.category) : getCategoryColor("Uncategorized")
                                    ...
                                    <div className="flex-1 mb-4 md:mb-0">
                                        ...
                                        <div className="max-w-2xl">
                                            ...
                                            <div className="flex items-center gap-4 mb-4">
                                                ...
                                                <span className="text-white/80 text-sm">{featuredBlog.dateCreated}</span>
                                            </div>
                                ...
                                <div className="rounded-2xl transition-shadow duration-300 overflow-hidden h-full">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-gray-500 text-sm">{blog.dateCreated}</span>
                                        </div>
                ...
                <div className="text-center">
                    {hasMore ? (
                        ...
                        <div className="flex flex-col items-center space-y-2">
                            ...
                            <p className="text-gray-400 text-sm">That's all our latest content for now</p>
                        </div>
                    ) : null}
                </div>
            </section>
