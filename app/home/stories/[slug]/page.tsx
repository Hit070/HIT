        ...
        return (
            <div className="min-h-screen bg-white">
                ...
                <div className="px-4 py-16 max-w-4xl mx-auto text-center">
                    ...
                    <Link href="/home/stories" className="text-[#bf5925] hover:underline">
                        ← Back to Stories
                    </Link>
                </div>
                <Footer />
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <article className="px-4 py-16 max-w-[1440px] mx-auto">
                {/* Breadcrumb */}
                <nav className="mb-8">
                    <Link href="/home/stories" className="text-gray-500 hover:text-[#bf5925]">
                        Stories
                    </Link>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {otherStories.map((otherStory: Story) => {
                                ...
                                return (
                                    <Link
                                        key={otherStory.id}
                                        href={`/home/stories/${otherStory.slug}`}
                                        ...
                                        <div className="p-6 space-y-3">
                                            ...
                                            <div className="flex justify-between items-center pt-4">
                                                <div className="flex flex-col">
                                                    <span className="text-gray-500 text-sm">{otherStory.dateCreated}</span>
